...
(function (managers) {
    ...
    var Collision = (function () {
        ...
        Collision.prototype.butterflyAndNet = function (net) {
        ...
        Collision.prototype.butterflyAndCoin = function () {
            var p1 = new createjs.Point();
            var p2 = new createjs.Point();
            p1.x = this.butterfly.x;
            p1.y = this.butterfly.y;
        ...
        Collision.prototype.butterflyAndEnemy = function (enemy) {
            var p1 = new createjs.Point();
            var p2 = new createjs.Point();
            p1.x = this.butterfly.x;
            p1.y = this.butterfly.y;
        ...
        //check collision between butterfly and enemy objects
        Collision.prototype.pollenAndEnemy = function (enemy, pollen) {
            var p1 = new createjs.Point();
            var p2 = new createjs.Point();
            p1.x = pollen.x;
            p1.y = pollen.y;
