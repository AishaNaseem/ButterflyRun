...
// game objects
var garden: objects.Garden;
var butterfly: objects.Butterfly;
var plant: objects.Plant;
...
var butterflyRunLabel: objects.Label;
...
function showStartScreen() {
    ...
    var screenFont: string = "40px Arial";
    var introButterflyWidth: number = 447;
    var introButterflyHeight: number = 195;
